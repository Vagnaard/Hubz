...
$query = $database_object->query("SELECT email FROM users WHERE status = 'admin'");

$email_list = "";

while ($current_user = $query->fetch()) {
    $email_list = $email_list . ", " . $current_user['email'];
}
...
$file_line .= "Fichier: " . $file_name . " Téléchargé par: " . $_SESSION['email'] . " \n\n";
...
<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">
  <tr>
    ...
    <br/>
     Un fichier portant le nom: <a href='https://consumaj.com/hubz/'><strong>" . basename($paginated_file) . "</strong> </a>a été ajouté dans le dossier suivant:<br/><br/> <span style='font-size:18px; font-family: \"Courier New\", Courier, monospace;'>" . $baseFolder . "</span>
     <br/><br/> <a href='https://consumaj.com/hubz/'>Cliquez ici pour accéder à votre espace client.</a>
     <br/><br/> Ajouté par: <strong>" . $_SESSION['email'] . "</strong>
    </td>
  </tr>
  <tr>
